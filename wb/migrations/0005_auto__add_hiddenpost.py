...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HiddenPost'
        db.create_table(u'wb_hiddenpost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'wb', ['HiddenPost'])


    def backwards(self, orm):
        # Deleting model 'HiddenPost'
        db.delete_table(u'wb_hiddenpost')
