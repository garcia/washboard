...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SeenAlert', fields ['user', 'alert']
        db.create_unique(u'wb_seenalert', ['user_id', 'alert_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SeenAlert', fields ['user', 'alert']
        db.delete_unique(u'wb_seenalert', ['user_id', 'alert_id'])
