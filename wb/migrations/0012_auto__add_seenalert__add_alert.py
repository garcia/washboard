...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeenAlert'
        db.create_table(u'wb_seenalert', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wb.Alert'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'wb', ['SeenAlert'])

        # Adding model 'Alert'
        db.create_table(u'wb_alert', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'wb', ['Alert'])


    def backwards(self, orm):
        # Deleting model 'SeenAlert'
        db.delete_table(u'wb_seenalert')

        # Deleting model 'Alert'
        db.delete_table(u'wb_alert')
    ...
    models = {
        ...
        u'wb.seenalert': {
            'Meta': {'object_name': 'SeenAlert'},
            'alert': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wb.Alert']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'wb.userprofile': {
