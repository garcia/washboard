...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rule.show_user'
        db.delete_column('wb_rule', 'show_user')

        # Deleting field 'Rule.show_keyword'
        db.delete_column('wb_rule', 'show_keyword')

        # Deleting field 'Rule.scan_tags'
        db.delete_column('wb_rule', 'scan_tags')

        # Deleting field 'Rule.scan_post'
        db.delete_column('wb_rule', 'scan_post')

        # Adding field 'Rule.whole_word'
        db.add_column('wb_rule', 'whole_word',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Rule.show_user'
        db.add_column('wb_rule', 'show_user',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Rule.show_keyword'
        db.add_column('wb_rule', 'show_keyword',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Rule.scan_tags'
        db.add_column('wb_rule', 'scan_tags',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Rule.scan_post'
        db.add_column('wb_rule', 'scan_post',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Rule.whole_word'
        db.delete_column('wb_rule', 'whole_word')
