...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'wb_rule', 'keyword', self.gf('wb.models.LowerCaseCharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Rule.keyword'
        db.alter_column(u'wb_rule', 'keyword', self.gf('wb.models.LowerCaseCharField')(max_length=256))
