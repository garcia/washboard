...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.preload_next_page'
        db.add_column(u'wb_userprofile', 'preload_next_page',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.preload_next_page'
        db.delete_column(u'wb_userprofile', 'preload_next_page')
    ...
    models = {
        ...
        u'wb.seenalert': {
            'Meta': {'unique_together': "(('alert', 'user'),)", 'object_name': 'SeenAlert'},
        ...
        u'wb.userprofile': {
            ...
            'preload_next_page': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
