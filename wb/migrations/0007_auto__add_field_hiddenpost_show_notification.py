...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HiddenPost.show_notification'
        db.add_column(u'wb_hiddenpost', 'show_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HiddenPost.show_notification'
        db.delete_column(u'wb_hiddenpost', 'show_notification')
