...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.twitter_button'
        db.add_column(u'wb_userprofile', 'twitter_button',
                      self.gf('django.db.models.fields.CharField')(default='hide', max_length=4),
                      keep_default=False)

        # Adding field 'UserProfile.facebook_button'
        db.add_column(u'wb_userprofile', 'facebook_button',
                      self.gf('django.db.models.fields.CharField')(default='hide', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.twitter_button'
        db.delete_column(u'wb_userprofile', 'twitter_button')

        # Deleting field 'UserProfile.facebook_button'
        db.delete_column(u'wb_userprofile', 'facebook_button')
    ...
    models = {
        ...
        u'wb.userprofile': {
            ...
            'facebook_button': ('django.db.models.fields.CharField', [], {'default': "'hide'", 'max_length': '4'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'twitter_button': ('django.db.models.fields.CharField', [], {'default': "'hide'", 'max_length': '4'}),
